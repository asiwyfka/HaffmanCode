...
public class Main {
    public static void main(String[] args) {
        ...
        String deCodingString = decoder1.deCodeDecimalStringToBinaryString("CodedText", coder1);
        ...
        System.out.println(codedLettersHashMap1);
        System.out.println();

        String decodedString = decoder1.decodeBinaryStringToString(deCodingString, codedLettersHashMap1);
